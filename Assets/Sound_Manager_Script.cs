...
{
    BGM_MAIN_MENU = 0,
    BGM_LEVEL_TUTORIAL = 1,
    BGM_LEVEL_1 = 2,
    BGM_LOSE = 3,
    BGM_WIN = 4,

    SFX_MECHA_HEAVY_1 = 100,
    SFX_MECHA_HEAVY_2 = 101,
    GOATZILLA_GROWL = 102,
    SFX_ATTACK = 103,
...
{
    private static Sound_Manager_Script mInstance;

    public static Sound_Manager_Script Instance
    {
        get
        {
            if (mInstance == null)
            {
                ...
                mInstance = tempObject.GetComponent<Sound_Manager_Script>();
    ...
    void Awake()
    {
        if (Sound_Manager_Script.CheckInstanceExist())
        {
